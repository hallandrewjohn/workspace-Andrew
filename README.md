# com-chilipeppr-workspace-andrew
A ChiliPeppr Workspace andrew.

![alt text](screenshot.png "Screenshot")

## ChiliPeppr Workspace / andrew
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-andrew |
| Name                  | Workspace / andrew |
| Description           | A ChiliPeppr Workspace andrew. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/hallandrewjohn/workspace-Andrew/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/hallandrewjohn/andrewscnc |
| Github URL            | http://github.com/hallandrewjohn/workspace-Andrew |
| Test URL              | https://preview.c9users.io/hallandrewjohn/andrewscnc/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/hallandrewjohn/workspace-Andrew/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-andrew"], // the id you gave your workspace
      function(myWorkspaceAndrew) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / andrew just got loaded.", myWorkspaceAndrew);
        myWorkspaceAndrew.init();
      }
    );
  }
);
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-andrew"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / andrew"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"A ChiliPeppr Workspace andrew."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/hallandrewjohn/workspace-Andrew/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/hallandrewjohn/andrewscnc"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/hallandrewjohn/workspace-Andrew"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://andrewscnc-hallandrewjohn.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
